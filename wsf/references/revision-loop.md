...
|----------|---------------|---------------|-------|
| plan-phase | wsf-planner | wsf-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | wsf-executor | wsf-verifier | Post-execution verification |
| discuss-phase | orchestrator | wsf-plan-checker | Inline revision by orchestrator |
