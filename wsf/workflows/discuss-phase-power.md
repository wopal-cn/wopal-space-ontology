...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/wsf-discuss-phase`.
...
Consider running /wsf-discuss-phase {N} again to refine before planning.
```
