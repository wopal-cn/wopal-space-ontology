...
<required_reading>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/verification-patterns.md
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/verification-report.md
</required_reading>
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" roadmap get-phase "${phase_number}"
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" roadmap analyze
```
...
Use wsf-tools to extract must_haves from each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" roadmap get-phase "${phase_number}" --raw)
```
...
Use wsf-tools for artifact verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" verify artifacts "$plan")
...
Use wsf-tools for key link verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" verify key-links "$plan")
...
See /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/verification-report.md for complete template.
</step>
