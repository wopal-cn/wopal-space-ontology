...
- wsf-executor — executes a specific, scoped code change
</available_agent_types>
...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" init audit-uat 2>/dev/null || echo "{}")
