...
This workflow wires Phase 1 (session pipeline) and Phase 2 (profiling engine) into a cohesive user-facing experience. All heavy lifting is done by existing wsf-tools.cjs subcommands and the wsf-user-profiler agent -- this workflow orchestrates the sequence, handles branching, and provides the UX.
</purpose>
...
Key references:
- @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/ui-brand.md (display patterns)
- @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/agents/wsf-user-profiler.md (profiler agent definition)
- @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/USER-PROFILE.md" "/Users/sam/coding/wopal/wopal-workspace/.wopal/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/USER-PROFILE.md
...
- options:
  ...
  - "Not now" -- Display "No worries. Run /wsf-profile-user when ready." and exit
...
Run session scan:
```bash
SCAN_RESULT=$(node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs profile-sample --json 2>/dev/null)
```
...
**Spawn wsf-user-profiler agent using Task tool:**

Use the Task tool to spawn the `wsf-user-profiler` agent. Provide it with:
- The sampled JSONL file path from profile-sample output
- The user-profiling reference doc at `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/user-profiling.md`
...
Reference: @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANSWERS_PATH=$(mktemp /tmp/wsf-profile-answers-XXXXXX.json)
```
...
```bash
ANALYSIS_RESULT=$(node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
ANALYSIS_PATH=$(mktemp /tmp/wsf-profile-analysis-XXXXXX.json)
```
...
```bash
node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  - "/wsf-dev-preferences command file" -- "Load your preferences in any session"
  - "CLAUDE.md profile section" -- "Add profile to this project's CLAUDE.md"
  - "Global CLAUDE.md" -- "Add profile to /Users/sam/coding/wopal/wopal-workspace/.wopal/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/USER-PROFILE.md" and jump to step 10.
...
**For /wsf-dev-preferences (if selected):**

```bash
node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /wsf-dev-preferences at /Users/sam/coding/wopal/wopal-workspace/.wopal/commands/wsf/dev-preferences.md"

**For CLAUDE.md profile section (if selected):**

```bash
node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /Users/sam/coding/wopal/wopal-workspace/.wopal/CLAUDE.md"

**Error handling:** If any wsf-tools.cjs call fails, display the error message and use AskUserQuestion to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```bash
BACKUP_PATH="/Users/sam/coding/wopal/wopal-workspace/.wopal/USER-PROFILE.backup.md"
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 WSF > PROFILE COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Your profile:    /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /wsf-dev-preferences   /Users/sam/coding/wopal/wopal-workspace/.wopal/commands/wsf/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/sam/coding/wopal/wopal-workspace/.wopal/CLAUDE.md
```
...
- [ ] Artifacts generated sequentially via wsf-tools.cjs subcommands
