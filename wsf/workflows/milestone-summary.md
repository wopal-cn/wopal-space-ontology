...
4. If nothing found: error "No milestone found. Run /wsf-new-project or /wsf-new-milestone first."
...
```bash
wsf-tools.cjs commit "docs(v${VERSION}): generate milestone summary for onboarding" \
...
If the user is done:
- Suggest next steps: `/wsf-new-milestone`, `/wsf-progress`, or sharing the summary with the team

## Step 9: Update STATE.md

```bash
wsf-tools.cjs state record-session \
