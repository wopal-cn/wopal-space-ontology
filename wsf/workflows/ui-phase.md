<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates wsf-ui-researcher and wsf-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
AGENT_SKILLS_UI=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" agent-skills wsf-ui-researcher 2>/dev/null)
AGENT_SKILLS_UI_CHECKER=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" agent-skills wsf-ui-checker 2>/dev/null)
```
...
```bash
UI_RESEARCHER_MODEL=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" resolve-model wsf-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" resolve-model wsf-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /wsf-settings.
```
Exit workflow.
...
```bash
PHASE_INFO=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" roadmap get-phase "${PHASE}")
```
...
Recommended: run /wsf-discuss-phase {N} first to capture design preferences.
...
## 5. Spawn wsf-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 WSF ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read /Users/sam/coding/wopal/wopal-workspace/.wopal/agents/wsf-ui-researcher.md for instructions.
...
Template: /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/UI-SPEC.md
</output>
...
Task(
  ...
  subagent_type="wsf-ui-researcher",
...
## 7. Spawn wsf-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 WSF ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read /Users/sam/coding/wopal/wopal-workspace/.wopal/agents/wsf-ui-checker.md for instructions.
...
- Re-spawn wsf-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /wsf-ui-phase
...
`/clear` then: `/wsf-plan-phase {N}`

{If CONTEXT.md does NOT exist:}
**Discuss Phase {N}** — gather implementation context before planning

`/clear` then: `/wsf-discuss-phase {N}`

(or `/wsf-plan-phase {N}` to skip discussion)
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] wsf-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] wsf-ui-checker spawned with UI-SPEC.md
