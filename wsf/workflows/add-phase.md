...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" init add-phase $ARGUMENTS)
...
Run /wsf-new-project to initialize.
```
Exit.
</step>
...
```bash
RESULT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" --cwd "${project_root}" phase add "${description}")
```
...
**Also available:**
- `/wsf-add-phase <description>` — add another phase
- Review roadmap
...
<success_criteria>
- [ ] `wsf-tools phase add` executed successfully
