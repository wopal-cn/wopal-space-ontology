...
Seeds auto-surface during /wsf-new-milestone when trigger conditions match the
...
This seed should be presented during `/wsf-new-milestone` when the milestone
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
...
This seed will surface automatically when you run /wsf-new-milestone
