...
Post-mortem investigation for failed or stuck WSF workflows. Analyzes git history,
...
3. {Recovery command if applicable — e.g., `/wsf-resume-work`, `/wsf-execute-phase N`}

---

*Report generated by `/wsf-forensics`. All paths redacted for portability.*
```
