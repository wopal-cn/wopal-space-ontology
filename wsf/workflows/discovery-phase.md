...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /wsf-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/discovery.md
...
Use /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/discovery.md.
...
1. Discuss phase context (/wsf-discuss-phase [current-phase])
2. Create phase plan (/wsf-plan-phase [current-phase])
