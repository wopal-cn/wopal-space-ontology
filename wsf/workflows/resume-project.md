...
<required_reading>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" init resume)
...
**If `planning_exists` is false:** This is a new project - route to /wsf-new-project
</step>
...
- This is the primary resumption source — structured data from `/wsf-pause-work`
...
📋 [N] pending todos — /wsf-check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/wsf-execute-phase {phase} ${WSF_WS})
   OR
1. Discuss Phase 3 context (/wsf-discuss-phase 3 ${WSF_WS}) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/wsf-plan-phase 3 ${WSF_WS}) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/wsf-discuss-phase [N] ${WSF_WS}` — gather context first
  - `/wsf-research-phase [N] ${WSF_WS}` — investigate unknowns
