...
The PR branch contains only code changes — reviewers don't see WSF artifacts
...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" init pr-branch "$ARGUMENTS")
...
Or use /wsf-ship to create the PR automatically.
```
</step>
