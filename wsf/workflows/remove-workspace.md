<purpose>
Remove a WSF workspace, cleaning up git worktrees and deleting the workspace directory.
</purpose>
...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" init remove-workspace "$WORKSPACE_NAME")
...
First run `/wsf-list-workspaces` to show available workspaces, then ask:
