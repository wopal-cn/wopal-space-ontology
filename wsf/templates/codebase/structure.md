...
**New Slash Command:**
- Primary code: `commands/wsf/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `wsf/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `wsf/workflows/{name}.md`
- Usage: Reference from command with `@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/{name}.md`

**New Reference Document:**
- Implementation: `wsf/references/{name}.md`
...
**wsf/**
- Purpose: Resources installed to /Users/sam/coding/wopal/wopal-workspace/.wopal/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/sam/coding/wopal/wopal-workspace/.wopal/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
