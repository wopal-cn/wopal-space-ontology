...
- This section feeds directly into /wsf-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /wsf-plan-phase --gaps with root causes
...
**Creation:** When /wsf-verify-work starts new session
...
- `/wsf-verify-work {phase}` picks up from first pending/blocked test
