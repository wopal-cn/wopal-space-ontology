...
> **Note:** Planning methodology is in `agents/wsf-planner.md`.
...
<!-- For checkpoint task examples and patterns, see @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/wsf-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/tdd.md` for TDD plan structure.
...
See `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/user-setup.md` for full schema and examples
...
See `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/verify-phase.md` for verification logic.
