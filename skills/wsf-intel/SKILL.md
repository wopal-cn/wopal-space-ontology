...
- If no matches found, display: `No intel matches for '<term>'. Try /wsf-intel refresh to build the index.`
...
4. DO NOT use the wsf-tools config get-value CLI for the config gate -- it exits on missing keys
