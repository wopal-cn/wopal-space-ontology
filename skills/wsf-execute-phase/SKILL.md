...
<execution_context>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `wsf-tools init execute-phase` and per-subagent `<files_to_read>` blocks.
</context>

<process>
Execute the execute-phase workflow from @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/execute-phase.md end-to-end.
