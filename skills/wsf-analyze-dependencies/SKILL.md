...
<execution_context>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/analyze-dependencies.md
</execution_context>

<context>
No arguments required. Requires an active milestone with ROADMAP.md.

Run this command BEFORE `/wsf-manager` to fill in missing `Depends on` fields and prevent merge conflicts from unordered parallel execution.
</context>

<process>
Execute the analyze-dependencies workflow from @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/analyze-dependencies.md end-to-end.
