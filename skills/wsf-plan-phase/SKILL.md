...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped), spawn wsf-planner, verify with wsf-plan-checker, iterate until pass or max iterations, present results.
</objective>

<execution_context>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/plan-phase.md
...
- `--reviews` — Replan incorporating cross-AI review feedback from REVIEWS.md (produced by `/wsf-review`)
...
<process>
Execute the plan-phase workflow from @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/workflows/plan-phase.md end-to-end.
