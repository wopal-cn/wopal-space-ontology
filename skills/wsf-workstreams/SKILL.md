...
- `/wsf-new-milestone --ws <name>` to set up the milestone

### status
Run: `node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" workstream status <name> --raw --cwd "$CWD"`
