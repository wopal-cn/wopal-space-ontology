...
```bash
INIT=$(node "/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/bin/wsf-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/bin/wsf-tools.cjs" history-digest
```
...
@/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/references/thinking-models-planning.md
...
```bash
VALID=$(node "/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/bin/wsf-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/bin/wsf-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.agents/wsf/bin/wsf-tools.cjs" commit "docs($PADDED_PHASE): create phase plan" --files .planning/phases/$PADDED_PHASE-*/$PADDED_PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
