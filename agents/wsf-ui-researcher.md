...
Use template from `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/UI-SPEC.md`.
...
Read template: `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/UI-SPEC.md`
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
