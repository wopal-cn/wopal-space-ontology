...
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/thinking-models-execution.md
...
```bash
AUTO_CHAIN=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" config-get workflow._auto_chain_active 2>/dev/null || echo "false")
AUTO_CFG=$(node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" config-get workflow.auto_advance 2>/dev/null || echo "false")
```
...
**See @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/checkpoints.md**
...
```bash
node /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/templates/summary.md
...
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
