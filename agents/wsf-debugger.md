...
<required_reading>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/sam/coding/wopal/wopal-workspace/.wopal
                  → checks /Users/sam/coding/wopal/wopal-workspace/.wopal/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf
                  → writes to /Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/hooks/
...
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/thinking-models-debug.md
...
- Read @/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/common-bug-patterns.md
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/bin/wsf-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
