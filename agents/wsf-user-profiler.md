...
<reference>
@/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/sam/coding/wopal/wopal-workspace/.wopal/wsf/references/user-profiling.md` to load:
